  ...
  return (
    <div className="flex border-b-[2px] border-bl2 items-center justify-center w-[95%] px-12 py-1 mx-auto gap-10">
      ...
      <div className="flex justify-center items-center border-[1px] border-bl2  rounded-xl text-md text-gray-400 font-bold mr-20">
        <div className="border-l-2 border-bl2  w-[80px] flex justify-center items-center py-3 cursor-pointer hover:text-white hover:bg-blue-300 rounded-r-xl transition">ورود کاربر</div>
      ...
      <div className="border border-bl2  flex justify-center items-center p-2 rounded-lg text-gray-400 hover:text-blue-300 cursor-pointer transition"><FaCartShopping className="text-2xl  "/></div>
