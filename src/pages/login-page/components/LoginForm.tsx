        ...
        {({errors})=>{
            return(
                <Form className="flex flex-col w-full md:w-[650px] my-4 rounded-lg shadow-lg shadow-bl2 border-[1px] border-bl2 justify-center items-center pb-7 pt-14 px-6">
                    ...
                    <button type="submit" className="w-28 mt-6 mb-6 py-2 rounded-lg text-gray-500 text-lg border-1 shadow-lg shadow-bl2 border-[1px] border-bl2 hover:bg-bl1 transition">ورود</button>
